...
export default function BaristaPage() {
  const t = useTranslations("baristaPage")
  const tWorkshops = useTranslations("workshopsPage.workshops.barista")
