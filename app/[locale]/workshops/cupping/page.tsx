...
export default function CuppingPage() {
  const t = useTranslations("cuppingPage")
  const tWorkshops = useTranslations("workshopsPage.workshops.cupping")
